<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-2xl text-gray-900">Build Target Segment</h2>
    ...
    <div class="py-8" x-data="{
        name: '',
        criteria: [{ field: 'status', operator: '=', value: 'subscribed' }],
        count: '...',
        addField() {
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <form method="POST" action="{{ route('segments.store') }}">
                            ...
                            <div class="mb-8">
                                ...
                                <input id="name" type="text" name="name" x-model="name" required autofocus 
                                       placeholder="e.g. VIP Customers - Paris"
                            ...
                            <div class="mt-12 pt-8 border-t border-gray-100 flex items-center justify-end">
                ...
                <div class="space-y-6">
                    <x-card class="p-6 bg-gradient-to-br from-indigo-600 to-violet-700 text-white overflow-hidden relative">
                        ...
                        <div class="relative">
                            <span class="text-[10px] font-black uppercase tracking-widest opacity-60">Estimated Reach</span>
                    ...
                    <x-card title="Segment Logic" class="p-6">
                        <div class="space-y-4">
                            <div class="flex gap-3">
                                ...
                                <span class="text-xs text-gray-600 font-medium">Implicitly matches "Subscribed" status unless specified otherwise.</span>
                            </div>
                            <div class="flex gap-3">
                                <div class="w-6 h-6 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center flex-shrink-0 text-[10px] font-black">AND</div>
                                <span class="text-xs text-gray-600 font-medium">Multiple rules are combined using "AND" logic.</span>
                            </div>
                        </div>
                    </x-card>
                </div>
